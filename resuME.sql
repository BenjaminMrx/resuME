...
-- -----------------------------------------------------
-- Table `cv_db`.`section_has_cv`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cv_db`.`section_has_cv` (
  `section_id` INT NOT NULL,
  `cv_id` INT NOT NULL,
  `content` VARCHAR(45) NULL,
  `rank` VARCHAR(45) NULL,
  PRIMARY KEY (`section_id`, `cv_id`),
  INDEX `fk_section_has_cv_cv1_idx` (`cv_id` ASC),
  INDEX `fk_section_has_cv_section1_idx` (`section_id` ASC),
  CONSTRAINT `fk_section_has_cv_section1`
    FOREIGN KEY (`section_id`)
    REFERENCES `cv_db`.`section` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_section_has_cv_cv1`
    FOREIGN KEY (`cv_id`)
